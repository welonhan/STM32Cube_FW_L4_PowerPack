...
void BSP_IO_Config(PB_IO *io_ctrl)
{
	...
	HAL_GPIO_WritePin(SMUX_SEL_PIN_GPIO_PORT, 			SMUX_SEL_PIN, 			io_ctrl->SMB.SMUX_SEL);
	...
	//HAL_GPIO_WritePin(PMUX2_MODE_PIN_GPIO_PORT, 	PMUX2_MODE_PIN, 		io_ctrl->PMUX2.MODE);	
	HAL_GPIO_WritePin(PMUX2_CHA_EN_PIN_GPIO_PORT, 	PMUX2_CHA_EN_PIN,		io_ctrl->PMUX2.CHA_EN);
	HAL_GPIO_WritePin(PMUX2_CHB_EN_PIN_GPIO_PORT, 	PMUX2_CHB_EN_PIN,		io_ctrl->PMUX2.CHB_EN);
...
void BSP_OUTPUT_GPIO_Init(void)
{
  ...
  /* Enable the GPIO_LED Clock */
  PMUX2_CHA_EN_PIN_CLK_ENABLE();
	PMUX1_CTRL_PIN_CLK_ENABLE();
	PMUX1_MODE_PIN_CLK_ENABLE();
	SMUX_SEL_PIN_CLK_ENABLE();
	...
	GPIO_InitStruct.Pin = PMUX2_CHA_EN_PIN;
	HAL_GPIO_Init(PMUX2_CHA_EN_PIN_GPIO_PORT, &GPIO_InitStruct);
	HAL_GPIO_WritePin(PMUX2_CHA_EN_PIN_GPIO_PORT, 	PMUX2_CHA_EN_PIN,		GPIO_PIN_RESET);
	...
	GPIO_InitStruct.Pin = SMUX_SEL_PIN;
	HAL_GPIO_Init(SMUX_SEL_PIN_GPIO_PORT, &GPIO_InitStruct);
	HAL_GPIO_WritePin(SMUX_SEL_PIN_GPIO_PORT, 			SMUX_SEL_PIN, 			GPIO_PIN_RESET);
	...
	GPIO_InitStruct.Pin = PMUX2_CHB_EN_PIN;
	HAL_GPIO_Init(PMUX2_CHB_EN_PIN_GPIO_PORT, &GPIO_InitStruct);
	HAL_GPIO_WritePin(PMUX2_CHB_EN_PIN_GPIO_PORT, 	PMUX2_CHB_EN_PIN,		GPIO_PIN_RESET);
	...
	GPIO_InitStruct.Pin = WLC_EN_PIN;
	HAL_GPIO_Init(WLC_EN_PIN_GPIO_PORT, &GPIO_InitStruct);
	HAL_GPIO_WritePin(WLC_EN_PIN_GPIO_PORT, 				WLC_EN_PIN, 				GPIO_PIN_RESET);	
